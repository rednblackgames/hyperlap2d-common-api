...
public class MsgAPI {
    ...
    public static final String ACTION_UPDATE_LAYOUT_DATA = SANDBOX_PREFIX + ".ACTION_UPDATE_LAYOUT_DATA";
    public static final String ACTION_UPDATE_TALOS_ANCHOR_CONSTRAINT_DATA = SANDBOX_PREFIX + ".ACTION_UPDATE_TALOS_ANCHOR_CONSTRAINT_DATA";
    ...
    public static final String ACTION_REMOTE_LAYERS = GLOBAL_PREFIX + ".ACTION_REMOTE_LAYERS";
}
